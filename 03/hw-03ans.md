# Домашнее задание к занятию «Управляющие конструкции в коде Terraform» - Шульгатый Станислав
...
### Ответ
код вместе с основной частью задания в папке: [src](https://github.com/megasts/ter-homeworks/tree/terraform-03/03/src)
...
### Ответ:
  Ошибки: 
  1. Закрывающяя круглая скобка не на своем месте
  2. пробел в "platform_id " не нужен
  Правильный код:
```
[webservers]
%{~ for i in webservers ~}
